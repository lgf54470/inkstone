...
| 37 | F | SH-66 | 访客会话视角（先出 ADR） | 中–大 | 🟡 | ⏳ 本项回填（ADR-0003 已交付，实现待评审） |
| 38 | F | SH-67 | 渠道标记 `?ref=`（先出 ADR） | 中 | 🟡 | ⏳ 本项回填（ADR-0004 已交付，实现待评审） |
| 39 | F | SH-68 | 文件夹/标签 → 公开集合落地页（先出 ADR） | 大 | 🟡 | ⏳ 本项回填（ADR-0005 已交付，实现待评审） |
