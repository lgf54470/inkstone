...
- [ ] K1-07 `--kanban-tag-*`/chart 色板接令牌 + contrast 门禁（review #28；含 text-white×10、!important×2）
  - 进度：7a ✅ 标签色板入 tokens.css + AA 重标定 + 声明/对比度门禁；7b ✅ chart 调色板改读令牌（删第二套 hex，主题/强调色/白底三者切换均重绘）；待做 7c text-white×10 与「今天」徽标改语义对比令牌（`!important×2` 不复现，见日志）
