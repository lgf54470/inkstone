...
'settings.floating_window_size': '浮动窗口大小',
'settings.floating_window_size_description': '新建浮窗的默认尺寸，打开后仍可拖动和缩放',
'settings.floating_window_small': '小',
'settings.floating_window_medium': '中',
'settings.floating_window_large': '大',
'settings.floating_window_custom': '自定义',
'settings.floating_window_width': '浮窗宽度',
'settings.floating_window_height': '浮窗高度',
