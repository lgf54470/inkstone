...
'settings.floating_window_size': 'Floating window size',
'settings.floating_window_size_description': 'Default size for newly opened floating windows; they can still be dragged and resized',
'settings.floating_window_small': 'Small',
'settings.floating_window_medium': 'Medium',
'settings.floating_window_large': 'Large',
'settings.floating_window_custom': 'Custom',
'settings.floating_window_width': 'Floating window width',
'settings.floating_window_height': 'Floating window height',
