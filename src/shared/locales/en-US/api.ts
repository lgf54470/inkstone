...
'api.error.media_too_large': 'The media file is too large for this deployment',
'api.error.playlist_full': 'This playlist is full',
'api.error.storage_quota_reached': 'The storage quota has been reached',
'api.error.tag_name_taken': 'A tag with this name already exists',
