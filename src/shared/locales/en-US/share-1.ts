...
'share.list_truncated': 'Showing the first {count} shares — more exist.',
...
'share.batch_export_links': 'Export link list',
'share.batch_links_copied': 'Copied {count} links',
'share.batch_links_exported': 'Exported {count} links',
'share.batch_links_missing': '{count} selected shares are not in the current list and were left out',
'share.batch_links_none': 'None of the selected shares is in the current list',
'share.batch_print_qr': 'Print QR sheet',
'share.batch_extend_days': 'Extend by {days} days',
'share.batch_extend_success': 'Extended {count} links by {days} days',
'share.batch_extend_kept_permanent': '{count} links never expire — they were left as they were.',
'share.batch_extend_all_permanent': 'All {count} selected links never expire — there is nothing to extend.',
'share.batch_extend_none': 'None of the selected links has an expiry to extend.',
...
'share.category_expiring': 'Has Expiry',
'share.category_expiring_soon': 'Expiring Soon',
...
'share.custom_slug_invalid': 'Custom slug must be {min}-{max} letters, numbers, hyphens, or underscores',
...
'share.qr_sheet_title': 'Share QR Sheet',
'share.qr_sheet_count': '{count} links on this sheet',
'share.qr_sheet_channel': 'Every code on this sheet carries the channel marker ?ref={value}',
'share.qr_sheet_printed_at': 'Printed {time}',
'share.qr_sheet_hint': 'Scan a code to open the note it names.',
...
'share.status_filter_label': 'Filter by status',
