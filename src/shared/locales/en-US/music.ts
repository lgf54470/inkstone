...
'music.play': 'Play',
'music.pause': 'Pause',
'music.play_pause': 'Play or pause',
...
'music.make_offline': 'Make available offline',
'music.remove_offline': 'Remove from offline playback',
'music.make_offline_selected': 'Save {value0} for offline',
'music.offline_saved': 'Made {value0} available offline',
'music.offline_removed': 'Removed {value0} from offline playback',
'music.offline_save_failed': 'Could not save for offline playback',
'music.offline_quota_full': 'Offline storage is full',
'music.transfers_library_jobs': 'Batch tasks',
'music.job_metadata': 'Scanning tags',
...
'music.upload_unsupported': 'Unsupported audio or video format',
'music.upload_too_large': 'The file exceeds the size limit',
'music.upload_skipped_count': '{value0} file(s) skipped',
'music.upload_cancel': 'Cancel upload',
...
'music.queue_added_count': 'Added {value0} tracks to the queue',
'music.import_m3u': 'Import a playlist (M3U)',
'music.m3u_imported_partial': '{value1} of {value0} entries matched nothing in the library',
'music.m3u_imported_none': 'No entry in that playlist matched a track in the library',
...
'music.share_playlist': 'Share playlist',
'music.unshare_playlist': 'Stop sharing',
'music.share_link_copied': 'Share link copied',
'music.share_link_copy_failed': 'Could not copy the link',
'music.unshared_playlist': 'Playlist sharing turned off',
...
'music.search_lyrics': 'Search lyrics online',
'music.search_lyrics_confirm': 'Replace the stored lyrics of "{value0}" with the online match?',
'music.replace': 'Replace',
'music.lyrics_matched': 'Lyrics updated',
'music.lyrics_unmatched': 'No lyrics matched this track',
'music.lyric_search_failed': 'Lyric search failed',
...
'music.lyrics': 'Lyrics',
'music.loop_start': 'Mark loop start (A)',
'music.loop_marker_a': 'A',
'music.loop_marker_b': 'B',
'music.loop_end': 'Mark loop end (B)',
...
'music.select_all_tracks': 'Select all tracks',
'music.move_to_tag': 'Move to tag',
'music.moved_to_tag': 'Moved {value0} track(s)',
...
'music.eq_preset_flat': 'Flat',
'music.eq_preset_pop': 'Pop',
'music.eq_preset_rock': 'Rock',
'music.eq_preset_vocal': 'Vocal',
'music.eq_preset_bass': 'Bass',
'music.eq_bass': 'Bass',
'music.eq_mids': 'Mids',
