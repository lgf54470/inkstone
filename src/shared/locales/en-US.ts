export const EN_US_MESSAGES = {
    ...
    "settings.sidebar_calendar_tree": "Sidebar calendar folders",
    "settings.sidebar_calendar_tree_desc": "The read-only tree that auto-files notes by creation time, shown at the top of the folder section.",
    "settings.show_empty_calendar_periods": "Show empty periods",
    "settings.show_empty_calendar_periods_desc": "Gray out year and month levels that have no notes, so gaps in your timeline stay visible.",
