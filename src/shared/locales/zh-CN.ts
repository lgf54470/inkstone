...
export const ZH_CN_MESSAGES = {
    ...
    "sidebar.calendar_day_tooltip_value0": "{value0} · {value1} 篇笔记 · 点击创建或打开日记",
    ...
    "sidebar.calendar_week_view": "周图",
    "sidebar.calendar_year_month_value0": "{value0} · {value1} 篇笔记",
    "sidebar.calendar_year_view": "年图",
    "sidebar.collapse": "折叠",
