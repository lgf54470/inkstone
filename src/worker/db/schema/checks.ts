...
export const REQUIRED_COLUMNS: Readonly<Record<string, readonly string[]>> = {
  ...
  share_collections: ['id', 'slug', 'user_id', 'target_type', 'target_value', 'password_hash', 'expires_at', 'is_enabled', 'member_sort', 'title', 'created_at', 'updated_at'],
  share_collection_members: ['collection_id', 'note_id', 'sort_order'],
  share_audit_log: ['id', 'user_id', 'note_id', 'slug', 'action', 'changed_json', 'created_at'],
  ...
  music_tracks: ['id', 'user_id', 'title', 'artist', 'album', 'duration_ms', 'source', 'object_key', 'mime', 'size_bytes', 'cover_url', 'lyric', 'is_favorite', 'is_pinned', 'play_count', 'last_played_at', 'content_hash', 'created_at', 'updated_at'],
...
export const REQUIRED_INDEXES = [
  ...
  'idx_share_audit_log_user',
  'idx_share_audit_log_note',
  'idx_share_collection_members_note',
  ...
  'idx_music_tracks_recent_play',
  'idx_music_tracks_hash',
