...
type DestructiveKey = 'deleteNote' | 'restoreNote' | 'restoreVersion' | 'purgeNote' | 'emptyTrash' | 'duplicateNote';

export const destructive = (set: SetNotesState, get: () => NotesState): Pick<NotesState, DestructiveKey> => ({
    deleteNote: (id) => deleteNoteImpl(set, get, id),
    restoreNote: (id) => restoreNoteImpl(set, get, id),
    restoreVersion: (id, versionId, content, title) => restoreVersionImpl(set, get, id, versionId, content, title),
    purgeNote: (id) => purgeNoteImpl(set, get, id),
    emptyTrash: () => emptyTrashImpl(set, get),
    duplicateNote: (id) => duplicateNoteImpl(set, get, id),
});
...
async function restoreNoteImpl(
    set: SetNotesState,
    get: () => NotesState,
    id: string,
): Promise<void> {
...
async function restoreVersionImpl(
    set: SetNotesState,
    get: () => NotesState,
    id: string,
    versionId: string,
...
async function duplicateNoteImpl(
    set: SetNotesState,
    get: () => NotesState,
    id: string,
): Promise<void> {
    ...
    await duplicatePendingNote(set, get, id, copyId);
}

async function duplicatePendingNote(
    set: SetNotesState,
    get: () => NotesState,
    id: string,
    copyId: string,
    ...
    try {
        ...
        if (!dirty.has(copyId))
            rollbackDuplicate(set, get, copyId, id);
