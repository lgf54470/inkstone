...
export function getBackupPresets(): BackupPreset[] {
  return [
    buildInfinicloudPreset(),
    buildKoofrPreset(),
    buildPcloudPreset(),
    buildBackblazePreset(),
    buildR2Preset(),
    buildTigrisPreset(),
  ]
}

function buildInfinicloudPreset(): BackupPreset {
  return {
    id: 'infinicloud',
    name: 'InfiniCLOUD',
    type: 'webdav',
    ...
    steps: [
      linkStep(t("settings.open"), 'My Page', 'https://infini-cloud.net/en/modules/mypage/usage/', t("settings.and_turn_on_apps_connection")),
...
function buildKoofrPreset(): BackupPreset {
  return {
    id: 'koofr',
    name: 'Koofr',
    type: 'webdav',
    ...
    steps: [
      linkStep(t("common.open"), t("settings.password_settings"), 'https://app.koofr.net/app/admin/preferences/password', t("settings.generate_a_new_app_password_use_your_registration_email_as_the_webdav_us")),
      ...
      linkStep(t("common.open"), 'Storage', 'https://app.koofr.net/app/storage/', t("settings.click_connect_in_the_left_sidebar_and_choose_the_cloud_storage_you_want")),
    ],
...
function buildPcloudPreset(): BackupPreset {
  return {
    id: 'pcloud',
    name: 'pCloud',
    type: 'webdav',
...
function buildBackblazePreset(): BackupPreset {
  return {
    id: 'backblaze',
    name: 'Backblaze B2',
    type: 's3',
    ...
    steps: [
      linkStep(t("common.open"), 'Buckets', 'https://secure.backblaze.com/b2_buckets.htm', t("settings.click_create_a_bucket_enter_only_the_bucket_name_leave_the_other_setting")),
      textStep(t("settings.after_creation_put_the_displayed_endpoint_into_endpoint_use_the_bucket_n")),
      linkStep(t("common.open"), 'Application Keys', 'https://secure.backblaze.com/app_keys.htm', t("settings.click_add_a_new_application_key_enter_any_name_of_key_leave_the_other_se")),
...
function buildR2Preset(): BackupPreset {
  return {
    id: 'r2',
    name: 'Cloudflare R2',
    type: 's3',
    ...
    steps: [
      linkStep(t("common.open"), t("settings.create_bucket_page"), 'https://dash.cloudflare.com/?to=/:account/r2/new', t("settings.enter_only_the_bucket_name_and_create_it_directly")),
      linkStep(t("common.open"), t("settings.api_token_page"), 'https://dash.cloudflare.com/?to=/:account/r2/api-tokens/create?type=user', t("settings.select_object_read_write_for_permissions_and_create_it_directly")),
...
function buildTigrisPreset(): BackupPreset {
  return {
    id: 'tigris',
    name: 'Tigris',
    type: 's3',
    ...
    steps: [
      linkStep(t("common.open"), 'Create Bucket', 'https://console.storage.dev/createbucket', t("settings.enter_only_the_bucket_name_leave_everything_else_unchanged_and_create_it")),
      linkStep(t("settings.then_open"), t("settings.create_access_key_page"), 'https://console.storage.dev/createaccesskey', t("settings.use_any_name_you_like_and_create_it")),
