...
export function Lightbox() {
    ...
    if (!lightbox)
        return null;
    return createPortal(<div ref={panelRef} role="dialog" aria-modal="true" aria-label={t("preview.image_preview")} tabIndex={-1} className="app-viewport-fixed anim-fade fixed z-[260] flex items-center justify-center bg-[oklch(0%_0_0/78%)] outline-none" onClick={close}>
