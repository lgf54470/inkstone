...
const apiCodeMessages: Record<string, MessageKey> = {
  ...
  media_too_large: 'api.error.media_too_large',
  playlist_full: 'api.error.playlist_full',
  storage_quota_reached: 'api.error.storage_quota_reached',
  tag_name_taken: 'api.error.tag_name_taken',
